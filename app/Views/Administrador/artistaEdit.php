...
<section>
    <div class="container">
        <div>
            <h2 class="mb-2">Actualizar artista</h2>
        </div>
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form id="form" action="<?php echo base_url('/actualizarArtista/' . $usuario->id) ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('/artistasLista') ?>" class="btn btn-danger">Cancelar y salir</a>
                        </form>
                    </div>
                </div>
            </div>
