    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form id="form" action="<?php echo base_url('/Admin/actualizarSubasta/'.$subasta['id'])?>" enctype="multipart/form-data" method="POST">
                            <div class="mb-3">
                            ...
                            <a href="<?php echo base_url('/subastasLista')?>" class="btn btn-danger">Cancelar</a>
