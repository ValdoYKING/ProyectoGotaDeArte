                        ...
                        <form id="form" action="<?php echo base_url('/Admin/actualizarPublicacion/'.$publicacion->id)?>"  enctype="multipart/form-data" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Mi obra" value="<?php echo $publicacion->nombre ?>" aria-label="Mi obra" aria-describedby="basic-icon-default-fullname2" pattern="[A-Za-záéíóúüÁÉÍÓÚÜ ]+" required>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input class="form-control" type="text" name="medidas" id="medidas" placeholder="Alto x largo x ancho" value="<?php echo $publicacion->medidas ?>" aria-label="Alto x largo x ancho" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input class="form-control" type="number" name="precio" id="precio" placeholder="Valor estimado" value="<?php echo $publicacion->precio ?>" aria-label="Valor estimado..." required>
