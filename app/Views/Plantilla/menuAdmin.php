<nav class="navbar navbar-expand-lg navbar-black bg-dark mb-5 desliza">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo base_url('/publicacionesLista')?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Listas Gota</a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <img src="<?php echo $urlPhoto?>" alt="Usuario" class="rounded-circle avatar avatar-xs pull-up">
                        <?php echo $userName; ?>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
